...
vista_admin_btn = Button(
    label="📂 Abrir panel de administración",
    button_type="success",
    width=300,
    height=60,
    css_classes=["boton-grande"]
)
...
archivo_html = Path(__file__).parent / "vista admin.html"
url = archivo_html.resolve().as_uri()  # convierte en ruta tipo file:///...
